...
namespace LapShopPr.Migrations
{
    ...
    [Migration("20241022002805_applicationuser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LapShopPr.Models.TbBusinessInfo", b =>
                {
            ...
            modelBuilder.Entity("LapShopPr.Models.TbCashTransacion", b =>
                {
            ...
            modelBuilder.Entity("LapShopPr.Models.TbCategory", b =>
                {
            ...
            modelBuilder.Entity("LapShopPr.Models.TbCustomer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShopPr.Models.TbItem", b =>
                {
            ...
            modelBuilder.Entity("LapShopPr.Models.TbItemDiscount", b =>
                {
            ...
            modelBuilder.Entity("LapShopPr.Models.TbItemImage", b =>
                {
            ...
            modelBuilder.Entity("LapShopPr.Models.TbItemType", b =>
                {
                    b.Property<int>("ItemTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShopPr.Models.TbO", b =>
                {
                    b.Property<int>("OsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShopPr.Models.TbPurchaseInvoice", b =>
                {
            ...
            modelBuilder.Entity("LapShopPr.Models.TbPurchaseInvoiceItem", b =>
                {
            ...
            modelBuilder.Entity("LapShopPr.Models.TbSalesInvoice", b =>
                {
                    b.Property<int>("InvoiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShopPr.Models.TbSalesInvoiceItem", b =>
                {
                    b.Property<int>("InvoiceItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShopPr.Models.TbSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShopPr.Models.TbSlider", b =>
                {
            ...
            modelBuilder.Entity("LapShopPr.Models.TbSupplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShopPr.Models.VwItem", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShopPr.Models.VwItemCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShopPr.Models.VwItemsOutOfInvoice", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(100)
            ...
            modelBuilder.Entity("LapShopPr.Models.VwMoView", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
                    ...
                    b.ToView("VwMoView", (string)null);
                });

            modelBuilder.Entity("LapShopPr.Models.VwSalesInvoice", b =>
                {
                    b.Property<Guid>("CustomerId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LapShopPr.Models.TbBusinessInfo", b =>
                {
                    b.HasOne("LapShopPr.Models.TbCustomer", "Cutomer")
                        .WithOne("TbBusinessInfo")
                        .HasForeignKey("LapShopPr.Models.TbBusinessInfo", "CutomerId")
            ...
            modelBuilder.Entity("LapShopPr.Models.TbItem", b =>
                {
                    b.HasOne("LapShopPr.Models.TbCategory", "Category")
                        .WithMany("TbItems")
                        .HasForeignKey("CategoryId")
                        .IsRequired()
                        .HasConstraintName("FK_TbItems_TbCategories");

                    b.HasOne("LapShopPr.Models.TbItemType", "ItemType")
                        .WithMany("TbItems")
                    ...
                    b.HasOne("LapShopPr.Models.TbO", "Os")
                        .WithMany("TbItems")
                        .HasForeignKey("OsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("LapShopPr.Models.TbItemDiscount", b =>
                {
                    b.HasOne("LapShopPr.Models.TbItem", "Item")
            ...
            modelBuilder.Entity("LapShopPr.Models.TbPurchaseInvoice", b =>
                {
                    b.HasOne("LapShopPr.Models.TbSupplier", "Supplier")
            ...
            modelBuilder.Entity("LapShopPr.Models.TbPurchaseInvoiceItem", b =>
                {
                    b.HasOne("LapShopPr.Models.TbPurchaseInvoice", "Invoice")
            ...
            modelBuilder.Entity("LapShopPr.Models.TbSalesInvoiceItem", b =>
                {
                    b.HasOne("LapShopPr.Models.TbSalesInvoice", "Invoice")
            ...
            modelBuilder.Entity("TbCustomerItem", b =>
                {
                    b.HasOne("LapShopPr.Models.TbCustomer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LapShopPr.Models.TbItem", null)
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
