...
public partial class LapShopContext :IdentityDbContext<ApplicationUser>
{
    ...
    public virtual DbSet<VwMoView> VwMoViews { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CategoryId); // Set primary key

            entity.Property(e => e.CategoryId)
                  .ValueGeneratedOnAdd(); // Configure as identity
        ...
        modelBuilder.Entity<VwMoView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwMoView");
